...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        products.put(new NearableID("736219a420d486dc"), new Product("Car",
        ...
        products.put(new NearableID("fe4e7ea0a271ed8f"), new Product("Bike",
                "Rush down the local streets with this amazing bike, leaving a trail of rainbow behind you, to the awe of everyone around.","Trump Tower"));
        ...
        showroomManager.setListener(new ShowroomManager.Listener() {
            ...
            public void onProductPickup(Product product) {
                ...
                else if(product.getName().equals("Bike")){

                    locationImage.setImageResource(R.mipmap.iv_test);
                }
